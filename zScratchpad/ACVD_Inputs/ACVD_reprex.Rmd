...
```{r}
jia_alpha_wide <- alpha.df
jia_alpha_long <- alpha.df.l
jia_bray_pcoa <- physeq.beta
jia_bray_pcoa_embed <- pca.df
```
...
```{r}
save(jia_alpha_wide, jia_alpha_long,
     jia_bray_pcoa, jia_bray_pcoa_embed, jie_bray_cap_embed,
